    ...
    <div class="main-container">
        <div class="invoice-container">
            ...
            <div class="invoice-item">
                <span>Voiture Louée</span>
                <span id="car-name"><?php echo htmlspecialchars($car_name); ?></span>
            </div>
            <div class="invoice-item">
                <span>Prix Quotidien</span>
                <span id="daily-price">$<?php echo htmlspecialchars($daily_price); ?></span>
            </div>
            <div class="invoice-item">
                <span>Nombre de jours</span>
                <span id="rental-days"><?php echo $days; ?> jours</span>
            </div>
            <div class="invoice-item">
                <span>Frais de prise en charge</span>
                <span id="pickup-fee">$50</span>
            </div>
            <div class="invoice-item">
            ...
            <div class="invoice-item">
                <span>Taxes (QC)</span>
                <span id="taxes">$<?php echo number_format($taxes, 2); ?></span>
            </div>
            <div class="invoice-item">
                <span>Total</span>
        ...
        <div class="payment-container">
                    ...
                    <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g id="Front">
                            ...
                            <g>
                                ...
                                <text transform="matrix(1 0 0 1 479.3848 435.6762)" class="st2 st10 st11">JUSQU'À</text>
            ...
            <div class="form-container">
                ...
                <div class="field-container">
                    <label for="cardnumber">Numéro de Carte</label><span id="generatecard">générer un numéro</span>
                ...
                <button class="confirm-button">Confirmer le Paiement</button>
            </div>
